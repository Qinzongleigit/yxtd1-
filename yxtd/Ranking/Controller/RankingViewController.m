...
- (void)viewDidLoad {
   ...
   UIScrollView*scrollView=[[UIScrollView alloc] initWithFrame:CGRectMake(0, 84, KscreenW, KscreenH-84)];
    ...
    self.topView=[[TopSliderVIew alloc] initWithFrame:CGRectMake(0, 0, KscreenW, 84)];
