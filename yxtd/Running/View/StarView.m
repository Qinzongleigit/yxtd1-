...
-(instancetype)initWithFrame:(CGRect)frame withFloatNum:(float) starNum{
    ...
    if ([super initWithFrame:frame]) {
        ...
        //水平方向控件间隔固定等间隔
        [starArray mas_distributeViewsAlongAxis:MASAxisTypeHorizontal withFixedSpacing:4 leadSpacing:6 tailSpacing:0];
        ...
        [starArray1 mas_distributeViewsAlongAxis:MASAxisTypeHorizontal withFixedSpacing:4 leadSpacing:6 tailSpacing:0];
        ...
        [starArray2 mas_distributeViewsAlongAxis:MASAxisTypeHorizontal withFixedSpacing:4 leadSpacing:6 tailSpacing:0];
